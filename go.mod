...
require (
	...
	go.etcd.io/etcd/etcdctl/v3 v3.5.30
	go.etcd.io/etcd/etcdutl/v3 v3.5.30
	go.etcd.io/etcd/pkg/v3 v3.5.30
	go.etcd.io/etcd/raft/v3 v3.5.30
	go.etcd.io/etcd/server/v3 v3.5.30
	go.etcd.io/etcd/tests/v3 v3.5.30
